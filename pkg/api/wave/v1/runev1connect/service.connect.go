...
const (
	...
	CertificateServiceName = "api.rune.v1.CertificateService"
)
...
const (
	...
	// GetCertificate RPC.
	CertificateServiceGetCertificateProcedure = "/api.rune.v1.CertificateService/GetCertificate"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	certificateServiceServiceDescriptor              = v1.File_service_proto.Services().ByName("CertificateService")
	certificateServiceGetCertificateMethodDescriptor = certificateServiceServiceDescriptor.Methods().ByName("GetCertificate")
)

// CertificateServiceClient is a client for the api.rune.v1.CertificateService service.
...
// NewCertificateServiceClient constructs a client for the api.rune.v1.CertificateService service.
...
// GetCertificate calls api.rune.v1.CertificateService.GetCertificate.
...
// CertificateServiceHandler is an implementation of the api.rune.v1.CertificateService service.
...
func NewCertificateServiceHandler(svc CertificateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.rune.v1.CertificateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCertificateServiceHandler) GetCertificate(context.Context, *connect.Request[v1.GetCertificateRequest]) (*connect.Response[v1.GetCertificateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.rune.v1.CertificateService.GetCertificate is not implemented"))
}

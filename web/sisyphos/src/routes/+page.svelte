...
<div class="flex flex-col gap-6 px-4 py-10">
  {#if services && selected}
    <a href="/{selected}/settings"
      class="flex flex-row justify-center items-center gap-2 p-4 rounded-lg cursor-pointer text-2xl transition-all duration-700 bg-slate-50/20 hover:bg-slate-50/40">
      {#if selected === "wave"}
